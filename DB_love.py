...
class Favorite(Base):
    """Создание таблицы пользователей, которым поставили лайк"""
...
class UserPhotoLike(Base):
    """Создание таблицы ЛАйк от пользователей"""
...
DATABASE_URI = 'postgresql+psycopg2://postgres:****@localhost/love'
